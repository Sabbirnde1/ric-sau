...
const publications = [
  {
    ...
    citations: 45,
    abstract: 'This paper presents novel neural network architectures specifically designed for medical image analysis, achieving state-of-the-art performance in diagnostic accuracy.',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto">
              Explore our comprehensive collection of research papers, articles, and publications 
              that contribute to the advancement of science and technology.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300 mb-2">
                {Math.round(publications.reduce((sum, p) => sum + p.citations, 0) / publications.length)}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600">
              Browse our research contributions across various domains and publication venues.
            </p>
          </motion.div>
