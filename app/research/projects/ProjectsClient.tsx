...
import { Search, Filter, Calendar, User, ArrowRight, Github } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <section className="py-24 bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">Research Projects</h1>
            <p className="text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto">
              Discover our ongoing and completed research initiatives that are shaping the future of technology and innovation.
            </p>
          </motion.div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{filteredProjects.length} Projects Found</h2>
            <p className="text-gray-600">Explore our diverse portfolio of research projects across various domains.</p>
          </motion.div>
                ...
                >
                  <div className="relative h-48 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 bg-blue-600 text-white text-sm font-medium rounded-full">{project.category}</span>
                    </div>
                    <div className="absolute top-4 right-4">
                      <span
                        className={`px-3 py-1 text-white text-sm font-medium rounded-full ${
                          project.status === 'Active' ? 'bg-green-500' : project.status === 'Completed' ? 'bg-gray-500' : 'bg-yellow-500'
                        }`}
                      >
                        {project.status}
                      </span>
