        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-blue-100 max-w-4xl mx-auto">
              ...
              and staffed by world-class researchers and scientists.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300 mb-2">
                {labs.reduce((sum, lab) => sum + lab.members, 0)}
              </div>
              <div className="text-blue-100">Researchers</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300 mb-2">
                {labs.reduce((sum, lab) => sum + lab.projects, 0)}
              </div>
              <div className="text-blue-100">Active Projects</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
              <div className="text-3xl font-bold text-yellow-300 mb-2">
                {labs.reduce((sum, lab) => sum + lab.publications, 0)}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore our world-class research laboratories where innovation meets excellence. 
              Each lab is equipped with state-of-the-art technology and led by renowned experts.
            </p>
          </motion.div>
          ...
          <div className="space-y-16">
            {labs.map((lab, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`lab-card grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Schedule a visit to see our state-of-the-art facilities and meet our research teams. 
